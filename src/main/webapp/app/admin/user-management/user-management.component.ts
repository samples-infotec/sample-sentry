...
export default class CoreUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-samplesentryapp-alert'], {
          param: decodeURIComponent(res.headers['x-samplesentryapp-params'].replace(/\+/g, ' ')),
        });
