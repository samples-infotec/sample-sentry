...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("mx.infotec.sample.sentry.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("mx.infotec.sample.sentry.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
