...
import mx.infotec.sample.sentry.SampleSentryApp;
import mx.infotec.sample.sentry.config.AsyncSyncConfiguration;
import mx.infotec.sample.sentry.config.EmbeddedMongo;
...
@SpringBootTest(classes = { SampleSentryApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
